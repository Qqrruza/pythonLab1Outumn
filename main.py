...
def set_background(root, image_path):
    ...
    canvas.create_image(300, 250, image=bg_image, anchor="center")
...
def create_interface(canvas):
    title_lbl = tk.Label(canvas,
                        text="MINECRAFT KEY GENERATOR",
                        font=("Arial", 18, "bold"),
                        fg="black")  
    canvas.create_window(300, 50, window=title_lbl)
    
    key_entry = tk.Entry(canvas,
                        font=("Courier", 14, "bold"),
                        justify="center",
                        state="readonly",
                        relief="solid",
                        width=25)
    canvas.create_window(300, 150, window=key_entry)
    ...
    generate_btn = tk.Button(canvas,
                           ...
                           padx=20,
                           pady=10)
    canvas.create_window(300, 200, window=generate_btn)
    return key_entry
